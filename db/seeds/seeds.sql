...
VALUES  ('100 planks', 'imageurl', 'This achievement is given to those who managed to plank for 2 minutes straight.', 100, 100),
        ...
        ('drink a cup of water', 'imageurl', 'This achievement is given to those who complete drinking 8 cups of water.', 100, 100),
        ('1 hour stillness', 'imageurl', 'This achievement is given to those who complete stillness task for a total of 1 hour.', 100, 100),
...
VALUES  ('Test','test123','test@email.com', 'TEST123', '2020-08-03', 0, 1),
        ('Kevin','123456','kkim@email.com', 'KVNKM', '2020-08-02', 500, 5),
        ('Victor','vliang','vliang@email.com', 'VLIANG', '2020-08-02', 2500, 30),
        ('opuser','op','op@email.com', 'opuser', '2020-08-02', 4000, 49);
